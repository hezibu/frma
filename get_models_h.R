...
full.model.h.1 <- lmer(log_h ~ log_arena + water + temp*log_pred*log_prey*ratio + 
...
full.model.h.2 <- lmer(log_h ~ log_arena + water + poly(temp,2)*log_pred*log_prey*ratio + 
...
full.model.h.ppmr <- lmer(log_h ~ log_arena + water + temp * ppmr * ratio + 
